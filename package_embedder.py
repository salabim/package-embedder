...
def get_embeddable_packages(infile):
    """
        ...
        for line in lines:
            if "import" in line:
                ...
                if (parts[0] == "import") or (parts[0] == "from" and parts[2] == "import"):
                    ...
                    if package not in result and package not in exclude_packages and _package_location(package):
...
def main():
    ...
    while True:
        window = sg.Window(
            "Package embedder",
            [[sg.Text("File to embed"), sg.Input(size=(80, 1)), sg.FileBrowse(file_types=[['Python files','*.py']])], [sg.OK(), sg.Cancel("Exit")]],
        )
        ...
        candidate_packages = get_embeddable_packages(infile)
            ...
            [
                ...
                *(
                    [
                        ...
                        sg.Checkbox(".py files only", key=(package, "py_files_only"), visible=not has_py_files_only(package), default=True),
                    ]
