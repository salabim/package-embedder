...
def embed(infile, selected_packages, outfile=None):
    ...
    with open(outfile, "w") as out:
        ...
        embedded_packages = [] # this is only required for the API. In the GUI this is always the like selected_packages
        for package, prefer_installed, py_files_only in selected_packages:
            if package_location(package):
    ...
    while True:
        ...
        while True:
            ...
            if isinstance(event, tuple):
                ...
                embedded_packages = embed(infile, selected_packages,outfile)
